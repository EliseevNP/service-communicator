...
module.exports = class AMQPTransporter extends BaseTransporter {
  constructor(options) {
    try {
      ...
      if (!options.hasOwnProperty('host')) throw new Error('Unable to create AMQPTransporter. \'options\' object should include \'host\' property');
      if (!options.hasOwnProperty('port')) throw new Error('Unable to create AMQPTransporter. \'options\' object should include \'port\' property');
